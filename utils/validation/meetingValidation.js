...
event_date : joi.string().allow(null).allow(''),
event_time : joi.string().allow(null).allow(''),
event_location : joi.string().allow(null).allow(''),
event_message : joi.string().allow(null).allow(''),
  }).unknown(true);
